...
# adjust parameters (in YAML header) and run this command, 
...
scen_pypsa_base_gams <- write_script(
  scen_pypsa_base, 
  solver = GAMS_barrier
  # solver = GAMS_mac,
...
# solve(scen_pypsa_base_gams, wait = F)
# scen_pypsa_base_gams <- read(scen_pypsa_base_gams)
# summary(scen_pypsa_base_gams)
# fname <- file.path(p$scen$BASE$root, glue("{p$scen$BASE$name}.RData"))
